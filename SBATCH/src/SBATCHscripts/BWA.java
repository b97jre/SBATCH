...
public class BWA {
	...
	public void help(){
		...
		System.out.println();
		System.out.println();
		System.out.println("Mandatory values for BWA:");
		System.out.println(Functions.fixedLength("-refFile <pathToBWAref>", 50)+"The reference file generated by BWA");
	...
	public boolean setParameters(Hashtable<String, String> T){
	...
	public void BWAinitiate(SBATCHinfo sbatch, String timeStamp, String inDir,
		...
		try {
			...
			if (files) {
				BWAFile(EW, sbatch,  outDir, forward, reverse,
						forward);
			} else {
			...
			try {
				...
				if (pairs.size() != 0) {
					for (int i = 0; i < pairs.size(); i++) {
						...
						BWAFile(generalSbatchScript, sbatch,  outDir,
					...
					for (int i = 0; i < fileNames.size(); i++) {
						...
						String newOutDir = outDir + "/" + fileName + "_"
								+ refName;
						BWAFile(generalSbatchScript, sbatch, 
	...
	public void BWAFile(ExtendedWriter generalSbatchScript, SBATCHinfo sbatch,
			 String outDir, String forward, String reverse,
			String readsName) {
		...
		try {
			...
			ExtendedWriter EW = new ExtendedWriter(new FileWriter(
					sbatchFileName));
			sbatch.printSBATCHinfo(EW, outDir, sbatch.getTimeStamp(), readsName, "BWA");
